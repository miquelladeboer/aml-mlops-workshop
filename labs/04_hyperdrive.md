...
8. Run the script `code\explore\deeptrain_submit.py`
You will get an error message.
This error message occurs, because we tried to run our script locally. This is not possible for HyperDrive. If we want no run this, we need to use Azure ML compute. Follow the next tuturial on how to create remote compute and how to submit a run on remote compute.
